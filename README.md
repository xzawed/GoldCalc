...
│   │   ├── common/               # ErrorAlert
│   │   ├── calculator/           # 1구역 계산기 (GoldCalculator, UnitSelector, PuritySelector, PriceDisplay)
...
│   ├── hooks/                    # TanStack Query 기반 데이터 훅 (useGoldPrice, useExchangeRate, useGoldHistory, useForecast, useMarketSignals, useOnlineStatus)
│   ├── utils/                    # 순수 함수 (goldCalc, historyCalc, forecast, format, api)

...
[![Railway](https://img.shields.io/badge/Railway-배포중-7B2FBE?logo=railway)](https://goldcalc.up.railway.app)

**🚀 프로덕션**: https://goldcalc.up.railway.app
...
- **배포**: Railway + GitHub 연동 자동 배포
  - `main` 푸시 → Railway 프로덕션 자동 배포 → https://goldcalc.up.railway.app

 ...
 *
 * 반환 객체를 useMemo로 안정화하여 불필요한 리렌더 방지
 */
export function useApiAvailability(): Record<AssetTab, boolean | null> {
  ...
  }, [goldData, goldError, goldLoading, silverData, silverError, silverLoading, rateData, rateError, rateLoading, domesticData, domesticError, domesticLoading])
}
